SYSTEMS.ML_PARLAY = $.extend({}, SYSTEM_BASE, {
...
SYSTEMS.ML_OR_SPREAD_PARLAY = $.extend({}, SYSTEM_BASE, {

	DESCRIPTION: "Parlay all fitting ML or +1.5 selections of a day respectively",
	NAME: "Day parlay: ML or +1.5",
	BET: BETING_TYPE.PARLAY,
	filterAfter: false,
	process: function(games) {
		var parlay = {plays: []};
